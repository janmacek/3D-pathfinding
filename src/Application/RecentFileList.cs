 ...
 * File: RecentFileList.cs                                                                                  *
 *      - ulozi a vyhlada posledne ulozene subori v registroch a zobrazi ich do menu v GUI rozhrani         *
...
namespace Common
{
	public class RecentFileList : MenuItem
	{
		...
		void SetMenuItems()
		{
			...
			InsertMenuItems();
            foreach (MenuItem item in FileMenu.Items) {
                if (item.Header == null) {
		...
		void InsertMenuItems()
		{
			...
			foreach ( RecentFile r in _RecentFiles )
			{
                ...
                r.MenuItem.Width = 420;
                r.MenuItem.Margin = new Thickness(0, 0, -80, 0);
                r.MenuItem.Padding = new Thickness(3, 3, 0, -2);
                r.MenuItem.HorizontalContentAlignment = System.Windows.HorizontalAlignment.Left;
